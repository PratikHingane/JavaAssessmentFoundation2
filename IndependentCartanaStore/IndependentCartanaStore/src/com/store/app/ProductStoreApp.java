...
public class ProductStoreApp {
	...
	public static void main(String[] args) {
		try(Scanner scanner = new Scanner(System.in);
			...
			System.out.println("-------------------Indian Mart-----------------");
			
			boolean loop = true;
			
			while(loop) {
				System.out.println("Enter your choice: "); //taking the choice from user
				System.out.println("0. to exit");
				System.out.println("1. to add a new product");
				System.out.println("2. to list products by category");
				System.out.println("3. to search a product by item code or its name");
				...
				case 2:
					...
					System.out.println("1. for CAMERA,\n2. for LAPTOP,\n3. for WATCH,\n4. for MOBILE");
					int categorySearchChoice = scanner.nextInt();
					...
					if(categorySearchCount == 0) {
						System.err.println("No any product in this category");
						System.err.println("Add the product first!");
					}
					break;
				...
				case 3:
					...
					if(productSearchCount == 0) {
						System.err.println("The product with the input name OR code doesn't exist!!!");
